...
if($method=='POST'){
  ...
  $title = $_POST['title'];
  $desc = $_POST['desc'];
  $sql =   "INSERT INTO `threads` (`threads_title`, `threads_desc`, `timestamp`, `threads_user_id`, `threads_cat_id`) VALUES ('$title', '$desc', current_timestamp(), '0', '1')";
...
<br>
  ...
  <section id="testimonials">
    <div class="forum">
        ...
        <?php
  $sql =   "SELECT * FROM `threads` WHERE threads_cat_id = 1";
  $result = mysqli_query($conn, $sql);
 $check= true;
  ...
  <section id="features">
    <div class="about-us">
      ...
      <br>
        ...
        <br>
        <br>
        <form <?php echo "cppforum.php?catid=1"; ?> method="post">
            <div class="mb-3">
