...
<br>
<br>
<h3>Asking Doubts is how we progress, and here at *LOGO*  we encourage you to ask as many doubts as you want on this forum and get them answered by experts from the community in no time!</h3>
<br>
<br>
  ...
  <section id="testimonials">
    <div class="forum">
        ...
        <?php
  $sql =   "SELECT * FROM `threads` WHERE threads_cat_id = 2";
  $result = mysqli_query($conn, $sql);
 $check= true;
